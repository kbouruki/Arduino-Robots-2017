//code for infrared sensor activating speakers (emergency sounds)
...
(rangeSensorAD.getRange()<5)
musicPlayer.setVolume(10,10);

if (rangeSensorAD.getRange()<4)
musicPlayer.setVolume(30,30);

if (rangeSensorAD.getRange()<3)
musicPlayer.setVolume(50,50);

if (rangeSensorAD.getRange()<2)
musicPlayer.setVolume(70,70);

else if (rangeSensorAD.getRange()<1)
